...
class ScriptMetrics:
    ...
    def get_common_errors(self, limit=10):
        """Получение самых распространенных типов ошибок
        
        Args:
            limit (int, optional): Максимальное количество типов ошибок для возврата
        
        Returns:
            list: Список кортежей (тип_ошибки, количество)
        """
        error_types = Counter(self.metrics["error_types"])
        return error_types.most_common(limit)
