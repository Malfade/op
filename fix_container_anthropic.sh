...
if [ -z "$CONTAINER_ID" ]; then
    echo "Ошибка: контейнер optimization не найден"
    exit 1
fi
...
echo "Патч успешно применен и бот перезапущен" 